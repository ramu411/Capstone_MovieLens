...
The formula for RMSE can be defined as follows with:
 ...
 - $\bar{y}_{u_1i}$ = the prediction of movieId by user

 - ${y}_{u_1i}$ = the rating of movieId i by userId

 - $N$ = the number of userId and movieId combinations and the sum of these different combinations


$$ \sqrt{\frac{1}{N} \sum_{u_1i} (\hat{y}_{u_1i} - y_{u_1i})^2} $$
...
$$ {y}_{u_1i} = \mu + bi + \varepsilon_{u_1i} $$
...
$$ {y}_{u_1i} = \mu + bi + bu + \varepsilon_{u_1i} $$
...
$$ {y}_{u_1i} = \mu + bi + bu + ba + \varepsilon_{u_1i} $$
...
This fuction penalizes outliesrs from $bi$, $bu$ and $ba$a such as users, movies and movie_age with very few ratings to optimize the recommendation system.
